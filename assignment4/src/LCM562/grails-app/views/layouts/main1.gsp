    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="active_company"><a href="company">COMPANIES</a></li>
          <li id="active_location"><a href="location">LOCATIONS</a></li>
          <li id="active_report"><a href="report">REPORTS</a></li>
          <li id="active_upload"><a href="upload">UPLOAD</a></li>
          <li id="active_login" onclick="alert('Working on it! Available soon!!');"><a href="#">LOGIN</a></li>
