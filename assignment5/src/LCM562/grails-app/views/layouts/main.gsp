...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<body>
          <div id="grailsLogo" role="banner"><a href="/LCM562"><img style="padding-left: 200px" src="${resource(dir: 'images', file: 'LCM_IronBow5_size2.png')}" alt="Lambert Condition Monitoring"/></a></div>
		<g:layoutBody/>
		<div class="footer" role="contentinfo"><p style="text-align: center">&copy; Sergio Sanguino Serrano 2013</p></div>
